    ...
    <div id="projects">
      ...
      <VerticalTimeline>
        ...
        >
          ...
          <p>Full Stack application using React and Mongodb</p>
              ...
              <Accordion>
                <Card>
                  ...
                  <Accordion.Collapse eventKey="0" className="text-left">
                    <Card.Body>
                      <strong>Description</strong> This is Expense tracker app
                      that tracks your everyday transaction.
                      <hr />
                      ...
                      <ul>
                        ...
                        <li>
                          <FaNode color="RGB(108, 194, 74)" size="50px" />
                          Node
                        </li>
                        <li>
        ...
        >
          ...
          <p>Simple Hangman Game using Tkinter Python</p>
          <div className="d-flex justify-content-between flex-column mt-1">
            <div>
              <Accordion>
                <Card>
                  ...
                  <Accordion.Collapse eventKey="0" className="text-left">
                    <Card.Body>
                      <strong>Description</strong> This is Hangman Game in which
                      you are asked to guess the animal name. You are given 7
                      chance to guess
                      <hr />
                      <strong>Features:</strong>
                      <ul className="list-styles pt-1">
                      ...
                      <ul>
                        <li>
                          <FaPython color="e34f26" size="50px" />
                          Python
                        </li>
                      </ul>
                    </Card.Body>
        ...
        >
          ...
          <p>AI Desktop Virtual Assistant.</p>
          <div className="d-flex justify-content-between flex-column mt-1">
            <div>
              <Accordion>
                <Card>
                  ...
                  <Accordion.Collapse eventKey="0" className="text-left">
                    <Card.Body>
                      <strong>Description</strong> This is Virtual Desktop
                      Assistant like siri or alexa.
                      <hr />
                      <strong>Features:</strong>
                      <ul className="list-styles pt-1">
